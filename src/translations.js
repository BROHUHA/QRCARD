export const Translations = [
  {
    ...
    translation: {
      ...
      'button.rotate': 'Portrait Mode',
      'button.print': 'Print',
      'button.picture.download': 'Download Picture',
      select: 'Select Language',
      // URL Card translations
      'url.title': 'URL Card',
      'url.card.title': 'Scan to Visit',
      'url.label': 'Website URL',
      'url.placeholder': 'https://example.com',
      'url.title.label': 'Card Title (optional)',
      'url.title.placeholder': 'My Website',
      'url.tip': 'Point your phone camera at the QR code to open the link',
      'url.hideTitle': 'Hide card title',
      'url.alert.empty': 'URL cannot be empty',
      // Social Card translations
      'social.title': 'Social Card',
      'social.platform': 'Platform',
      'social.username': 'Username',
      'social.phone': 'Phone Number',
      'social.invite': 'Invite Code',
      'social.channel': 'Channel Name',
      'social.displayName': 'Display Name (optional)',
      'social.displayName.placeholder': 'My Profile',
      'social.tip': 'Scan to connect',
      'social.hideDisplayName': 'Hide display name',
      'social.alert.empty': 'Please enter a value',
      // Guide translations
      'guide.title': 'Guide',
      'guide.step1': 'Select your card type.',
      'guide.step2': 'Fill in your details.',
      'guide.step3': 'Print or save your new QR Card!',
    },
  },
  {
    id: 'sv-SE',
